class Cache:
    ...
    def __init__(self):
        ...
        self._company_events_cache: dict[str, list[dict[str, any]]] = {}
    ...
    def get_company_events(self, ticker: str) -> list[dict[str, any]] | None:
        """Get cached company calendar events if available."""
        return self._company_events_cache.get(ticker)

    def set_company_events(self, ticker: str, data: list[dict[str, any]]):
        """Append new company events to cache."""
        self._company_events_cache[ticker] = self._merge_data(
            self._company_events_cache.get(ticker),
            data,
            key_field="event_id",
        )
